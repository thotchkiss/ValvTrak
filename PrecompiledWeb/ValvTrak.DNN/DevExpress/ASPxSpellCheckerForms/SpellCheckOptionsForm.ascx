...
<%@ Register Assembly="DevExpress.Web.v12.1" Namespace="DevExpress.Web.ASPxTabControl" TagPrefix="dxtc" %>
...
<%@ control language="vb" autoeventwireup="true" inherits="SpellCheckOptionsForm, App_Web_fzwmm01e" %>
