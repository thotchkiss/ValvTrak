...
<div class="container">
    <div class="C02_Grey_roundtop_leftD">
       <img src="<%=skinpath%>dummy.gif" alt="" class="C02_corner_left" style="display: none" />
    </div>
    <div class="C02_Grey_roundtop_rightD">
       <img src="<%=skinpath%>dummy.gif" alt="" class="C02_corner_right" style="display: none" />
    </div>
    <div class="C02_DarkGrey_roundcont">
       <div class="C02_DarkGrey_TitleLine">
           <div class="C02_Grey_DarkTitle">
       ...
       <div runat="server" id="ContentPane" class="C02_ContentPane"/>
    ...
    <div class="C02_Grey_roundbottom_leftD">
       <img src="<%=skinpath%>dummy.gif" alt="" class="C02_corner_left" style="display: none" />
    </div>
    <div class="C02_Grey_roundbottom_rightD">
       <img src="<%=skinpath%>dummy.gif" alt="" class="C02_corner_right" style="display: none" />
    </div>
</div>
