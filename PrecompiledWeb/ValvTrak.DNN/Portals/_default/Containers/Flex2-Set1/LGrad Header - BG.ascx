...
<table class="flex-container-2 fullwidth">
<tr class="EMContainerColour1">
<td class="flex-container-tl-lgrad trans-png"><img src="<%= SkinPath %>images/spacer.gif" height="33" width="14" alt="" /></td>
<td class="flex-container-t-lgrad trans-png">
...
<td class="flex-container-tr-lgrad trans-png"><img src="<%= SkinPath %>images/spacer.gif" height="33" width="14" alt="" /></td>
</tr>
<tr>
  <td class="flex-container-l"><img src="<%= SkinPath %>images/v2-l.gif" height="35" width="14" alt="" /></td>
  ...
  <td class="flex-container-r"><img src="<%= SkinPath %>images/v2-r.gif" height="35" width="14" alt="" /></td>
</tr>
