...
<td class="flex-container-tl-simple trans-png"><img src="<%= SkinPath %>images/spacer.gif" height="30" width="14" alt="" /></td>
...
<td class="flex-container-tr-simple trans-png"><img src="<%= SkinPath %>images/spacer.gif" height="30" width="14" alt="" /></td>
</tr>
<tr>
