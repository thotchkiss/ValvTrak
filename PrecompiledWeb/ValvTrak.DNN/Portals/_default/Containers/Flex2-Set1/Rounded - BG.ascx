...
<table class="flex-container-8 fullwidth EMContainerColour1">
<tr>
...
<tr>
  <td valign="top" class="flex-container-l trans-png"><img src="<%= SkinPath %>images/controunded2-l.png" height="59" width="12" class="trans-png"></td>
  ...
  <td valign="top" class="flex-container-r trans-png"><img src="<%= SkinPath %>images/controunded2-r.png" height="59" width="12" class="trans-png"></td>
</tr>
