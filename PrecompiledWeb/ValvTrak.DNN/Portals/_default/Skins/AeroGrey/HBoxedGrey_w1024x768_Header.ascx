...
<link href="<%=skinpath%>BoxedGrey.css" rel="stylesheet" type="text/css" />

<div id="PageBgImage">

<div id="OuterContainer" class="w1024x768">
	<div id="OuterContainerTop">
		<img src="<%=skinpath%>images/grey.TL.gif" alt="top left corner" width="10" height="10" class="corner" style="display: none;">
	</div>
	...
	<div id="OuterContainerBottom">
		<img src="<%=skinpath%>images/grey.BL.gif" alt="bottom left corner" width="10" height="10" class="corner" style="display: none;">
	</div>
</div>
