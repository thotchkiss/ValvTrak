...
<div id="OuterContainer" class="wFull">
	...
	<div id="OuterContainerMiddle">
		<div id="OuterContainerMiddlePadding">
		    <table width="95%" style="background-image:url(http://localhost/portal/portals/_default/skins/aeroblack/images/LogoBackground4.jpg); height:160px; background-repeat:no-repeat">
		        <tr>
		            <td>
		                <div id="HeaderRow">
