...
var params = { wmode: "transparent", FlashVars: "XMLpath=<%= SkinPath %>Template-Flash-760x212-01.images.xml" };
swfobject.embedSWF("<%= SkinPath %>flash/flex-760x212.swf", "FlashBannerContainer", "760", "212", "9.0.0", false, false, params);
</script>
