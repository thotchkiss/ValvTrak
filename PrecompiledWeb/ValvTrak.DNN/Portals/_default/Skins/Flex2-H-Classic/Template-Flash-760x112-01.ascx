...
var params = { wmode: "transparent", FlashVars: "XMLpath=<%= SkinPath %>Template-Flash-760x112-01.images.xml" };
swfobject.embedSWF("<%= SkinPath %>flash/flex-760x112.swf", "FlashBannerContainer", "760", "112", "9.0.0", false, false, params);
</script>
