...
var params = { wmode: "transparent", FlashVars: "XMLpath=<%= SkinPath %>Template-Flash-830x212-01.images.xml" };
swfobject.embedSWF("<%= SkinPath %>flash/flex-830x212.swf", "FlashBannerContainer", "830", "212", "9.0.0", false, false, params);
</script>
