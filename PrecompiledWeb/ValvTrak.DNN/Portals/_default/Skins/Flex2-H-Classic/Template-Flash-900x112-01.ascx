...
var params = { wmode: "transparent", FlashVars: "XMLpath=<%= SkinPath %>Template-Flash-900x112-01.images.xml" };
swfobject.embedSWF("<%= SkinPath %>flash/flex-900x112.swf", "FlashBannerContainer", "900", "112", "9.0.0", false, false, params);
</script>
