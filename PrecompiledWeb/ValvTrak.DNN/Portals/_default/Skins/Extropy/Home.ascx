                ...
                <div id="Layout-Content">
                    ...
                    <table class="Layout-Table">    
	                    <tr>
		                    ...
		                    <td id="ContentPane" class="Layout-ContentPane" runat="server">
		                        <p align="center">
		                            <object id="Object5" codetype="dotnetnuke/client" codebase="EmbedWidget" declare="declare">
                                        <param name="type" value="Flickr" />
                                        <param name="src" value="http://www.flickr.com/explore/interesting/7days/show/" />
                                    </object>
		                        </p>
		                    </td>    
