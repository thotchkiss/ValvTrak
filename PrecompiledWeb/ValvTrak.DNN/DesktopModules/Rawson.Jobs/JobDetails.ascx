<%@ control language="C#" autoeventwireup="true" inherits="Rawson.Jobs.Details, App_Web_vbmhhbxi" enabletheming="true" %>
...
<%@ Register assembly="DevExpress.Web.v15.1" namespace="DevExpress.Data.Linq" tagprefix="dx" %>
