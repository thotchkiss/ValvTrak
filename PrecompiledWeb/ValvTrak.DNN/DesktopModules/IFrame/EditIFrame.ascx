<%@ control language="vb" autoeventwireup="false" inherits="DotNetNuke.Modules.IFrame.EditIFrame, App_Web_115urjhf" %>
...
<div id="pnlOptions" runat="server">
    <table cellspacing="0" cellpadding="0" width="600" summary="Table to update IFrame settings"
        ...
        <tr>
            ...
            <td>
                <p>
                    <dnn:Url ID="urlSource" runat="server" ShowUrls="true" ShowTrack="false" ShowTabs="false"
