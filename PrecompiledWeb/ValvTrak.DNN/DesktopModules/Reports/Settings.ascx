<%@ Control Language="vb" AutoEventWireup="false" Inherits="DotNetNuke.Modules.Reports.Settings"
...
<div id="DataSourceSection" runat="Server">
    ...
    <asp:MultiView ID="ReportsSettingsMultiView" runat="server">
        ...
        <asp:View ID="SuperUserView" runat="server">
            <%-- Warning message, warns Host that this query will be run
                     whenever a user browses to the page --%>
            ...
            <table id="tblDataSource" runat="server" cellspacing="0" cellpadding="2" border="0"
                ...
                <tr>
                    ...
                    <td class="dnn_rpt_form_field">
                            <asp:TextBox ID="txtTitle" CssClass="NormalTextBox" Width="100%" runat="server" />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="dnn_rpt_form_field">
                        <asp:TextBox ID="txtParameters" CssClass="NormalTextBox" runat="server" Width="100%" />
                    </td>
                </tr>
            </table>
            ...
            <div runat="server" id="rowResults" visible="false" class="dnn_rpt_test_results">
                ...
                <br />
                <asp:LinkButton ID="btnHideTestResults" runat="server" CssClass="CommandButton" ResourceKey="btnHideTestResults" />
            </div>
            ...
            <div runat="server" id="rowXmlSource" visible="false" class="dnn_rpt_test_results">
                ...
                <asp:TextBox ID="txtXmlSource" runat="server" ReadOnly="true" CssClass="NormalTextBox"
                    TextMode="MultiLine" Rows="7" Width="100%" />
                <br />
                <div style="text-align: center">
                    <asp:LinkButton ID="btnHideXmlSource" runat="server" CssClass="CommandButton" ResourceKey="btnHideXmlSource" />
                </div>
            </div>
            ...
            <div id="ConvertersSection" runat="server">
                ...
                <table cellspacing="0" cellpadding="2" border="0" summary="Report Data Converter Settings Design Table"
                    ...
                    <tr>
                        ...
                        <td class="dnn_rpt_form_field">
                            <asp:TextBox ID="txtHtmlDecode" CssClass="NormalTextBox" runat="server" Width="100%" />
                        </td>
                    </tr>
                    <%-- HtmlEncode Filter --%>
                    <tr>
                        ...
                        <td class="dnn_rpt_form_field">
                            <asp:TextBox ID="txtHtmlEncode" CssClass="NormalTextBox" runat="server" Width="100%" />
                        </td>
                    </tr>
                </table>
            </div>
