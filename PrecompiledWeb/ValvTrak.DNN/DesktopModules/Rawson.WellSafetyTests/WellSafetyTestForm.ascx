<%@ control language="C#" autoeventwireup="true" inherits="Rawson.WellSafetyTests.WellSafetyTestForm, App_Web_zytu0qsj" enabletheming="true" %>
...
<ClientSideEvents GotFocus="function(s, e) {
	s.ShowDropDown();
							...
							<tr>
								<td colspan="5" align="left" bgcolor="Silver" style="padding: 5px;">
