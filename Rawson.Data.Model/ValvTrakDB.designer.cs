...
namespace Rawson.Data
{
    ...
    partial void DeleteRateValveTest(Rawson.Data.Model.RateValveTest instance);
		...
		public System.Data.Linq.Table<Rawson.Data.Model.RateValvePart> RateValveParts
		{
			get
			{
				return this.GetTable<Rawson.Data.Model.RateValvePart>();
			}
		}
...
namespace Rawson.Data.Model
{
    ...
    partial void OnVersionChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Job_RateValveTest", Storage="_RateValveTests", ThisKey="JobID", OtherKey="JobID")]
		public EntitySet<RateValveTest> RateValveTests
		{
			get
			{
				return this._RateValveTests;
			}
			set
			{
		...
		private void attach_RateValveTests(RateValveTest entity)
		{
			this.SendPropertyChanging();
			entity.Job = this;
		}
		
		private void detach_RateValveTests(RateValveTest entity)
		{
			this.SendPropertyChanging();
			entity.Job = null;
		}
    ...
    partial void OnLongitudeChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ServiceItem_RateValveTest", Storage="_RateValveTests", ThisKey="ServiceItemID", OtherKey="ServiceItemID")]
		public EntitySet<RateValveTest> RateValveTests
		{
			get
			{
	...
	public partial class RateValveTest : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.DateTime _DateTested;
		
		private int _ConditionOfWearSleeve;
		
		private int _ConditionOfDisc;
		
		private int _PercentDiscWear;
		
		private int _ExternalCondition;
    ...
    partial void OnFSRNumChanging(string value);
    partial void OnFSRNumChanged();
    partial void OnDateTestedChanging(System.DateTime value);
    partial void OnDateTestedChanged();
    partial void OnConditionOfWearSleeveChanging(int value);
    partial void OnConditionOfWearSleeveChanged();
    partial void OnConditionOfDiscChanging(int value);
    partial void OnConditionOfDiscChanged();
    partial void OnPercentDiscWearChanging(int value);
    partial void OnPercentDiscWearChanged();
    partial void OnExternalConditionChanging(int value);
    ...
    partial void OnVersionChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_RateValveTestID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		public int RateValveTestID
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ServiceItemID", DbType="Int NOT NULL", UpdateCheck=UpdateCheck.Never)]
		public int ServiceItemID
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FSRNum", DbType="VarChar(50)", UpdateCheck=UpdateCheck.Never)]
		public string FSRNum
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DateTested", DbType="SmallDateTime NOT NULL", UpdateCheck=UpdateCheck.Never)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ConditionOfWearSleeve", DbType="Int NOT NULL", UpdateCheck=UpdateCheck.Never)]
		public int ConditionOfWearSleeve
		{
			get
			{
				return this._ConditionOfWearSleeve;
			}
			set
			{
				if ((this._ConditionOfWearSleeve != value))
				{
					this.OnConditionOfWearSleeveChanging(value);
					this.SendPropertyChanging();
					this._ConditionOfWearSleeve = value;
					this.SendPropertyChanged("ConditionOfWearSleeve");
					this.OnConditionOfWearSleeveChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ConditionOfDisc", DbType="Int NOT NULL", UpdateCheck=UpdateCheck.Never)]
		public int ConditionOfDisc
		{
			get
			{
				return this._ConditionOfDisc;
			}
			set
			{
				if ((this._ConditionOfDisc != value))
				{
					this.OnConditionOfDiscChanging(value);
					this.SendPropertyChanging();
					this._ConditionOfDisc = value;
					this.SendPropertyChanged("ConditionOfDisc");
					this.OnConditionOfDiscChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PercentDiscWear", DbType="Int NOT NULL", UpdateCheck=UpdateCheck.Never)]
		public int PercentDiscWear
		{
			get
			{
				return this._PercentDiscWear;
			}
			set
			{
				if ((this._PercentDiscWear != value))
				{
					this.OnPercentDiscWearChanging(value);
					this.SendPropertyChanging();
					this._PercentDiscWear = value;
					this.SendPropertyChanged("PercentDiscWear");
					this.OnPercentDiscWearChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ExternalCondition", DbType="Int NOT NULL", UpdateCheck=UpdateCheck.Never)]
		public int ExternalCondition
		{
			get
			{
				return this._ExternalCondition;
			}
			set
			{
				if ((this._ExternalCondition != value))
				{
					this.OnExternalConditionChanging(value);
					this.SendPropertyChanging();
					this._ExternalCondition = value;
					this.SendPropertyChanged("ExternalCondition");
					this.OnExternalConditionChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Remarks", DbType="VarChar(4000)", UpdateCheck=UpdateCheck.Never)]
		...
		public Employee Employee
		{
			...
			set
			{
							...
							|| (this._Employee.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Employee.Entity = null;
						previousValue.RateValveTests.Remove(this);
					}
					this._Employee.Entity = value;
					if ((value != null))
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Job_RateValveTest", Storage="_Job", ThisKey="JobID", OtherKey="JobID", IsForeignKey=true)]
		public Job Job
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ServiceItem_RateValveTest", Storage="_ServiceItem", ThisKey="ServiceItemID", OtherKey="ServiceItemID", IsForeignKey=true)]
		public ServiceItem ServiceItem
		{
			get
			{
