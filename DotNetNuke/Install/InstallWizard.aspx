                        ...
                        <div id="advancedDatabase" class="dnnFormItem" style="display:none">
                            ...
                            <div id="securityUserDefined" class="dnnFormItem" style="display:none; padding-top: 5px;">
                                ...
                                <div class="dnnFormItem">
                                    ...
                                    <asp:RequiredFieldValidator ID="valDatabasePassword" CssClass="dnnFormMessage dnnFormError dnnRequired" runat="server" resourcekey="Password.Required" Display="Dynamic" ControlToValidate="txtDatabasePassword" />
                                </div>
                            </div>
                            <div class="dnnFormItem">
    ...
    <script type="text/javascript">
        ...
        function InstallWizard() {
            ...
            this.checkingDatabase = function () {
                ...
                $('#<%= lblDatabaseInfoMsg.ClientID %>').removeClass("databaseConnectionError");
                $('#<%= lblDatabaseInfoMsg.ClientID %>').addClass("loading");
                var i = 0;
                $(".loading").html('<%= Localization.GetSafeJSString(LocalizeString("TestingDatabase"))%>');
                            ...
                            if (result.Item1) {
                                ...
                                PageMethods.VerifyDatabaseConnection(installWizard.installInfo, function(valid) {
                                    ...
                                    if (valid.Item1) {
                                        ...
                                        $("#databaseError").show();
                                        $('#<%= lblDatabaseInfoMsg.ClientID %>').removeClass("loading");
                                        $('#<%= lblDatabaseInfoMsg.ClientID %>').addClass("databaseConnectionError");
