...
<div class="dnnForm dnnEditFolderMapping dnnClear" id="dnnEditFolderMapping">
            ...
            <div class="exfmsContent dnnClear">
                ...
                <fieldset>
                    ...
                    <div class="dnnFormItem">
                        ...
                        <dnn:DnnComboBox ID="cboFolderProviders" runat="server" AutoPostBack="true" CausesValidation="false" OnSelectedIndexChanged="cboFolderProviders_SelectedIndexChanged" />
    ...
    <ul class="dnnActions dnnClear">
        <li>
            <asp:LinkButton ID="cmdUpdate" runat="server" CssClass="dnnPrimaryAction" ResourceKey="cmdUpdate" IconKey="Add" ValidationGroup="vgEditFolderMapping" />
        <%--<dnn:CommandButton ID="cmdUpdate" runat="server" CssClass="dnnPrimaryAction" ResourceKey="cmdUpdate" IconKey="Add" ValidationGroup="vgEditFolderMapping" />--%>
        </li>
