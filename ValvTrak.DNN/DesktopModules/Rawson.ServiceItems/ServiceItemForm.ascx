...
<table>
	<tr>
		<td>
			<dxe:ASPxComboBox ID="ServiceItemSelect" runat="server" ClientInstanceName="siSelect" 
					DataSourceID="ServiceItemDataSource" Width="170px"
					TextField="DisplayMember" ValueField="ValueMember"
					ValueType="System.Int32" oncallback="ServiceItemSelect_Callback" 
				TabIndex="100" IncrementalFilteringMode="StartsWith" 
				EnableIncrementalFiltering="True" >
				<ClientSideEvents Init="function(s,e) { msiSelect = s; }"
		...
		<td>
			<dxe:ASPxButton ID="btnEdit" runat="server" ClientInstanceName="edit" 
				...
				<ClientSideEvents Click="function(s, e) { siPanel.PerformCallback(); }" />
			</dxe:ASPxButton>
		</td>
		<td>
										...
										<tr>
											<td>
												<dxe:ASPxComboBox ID="ModelSelect" runat="server" EnableClientSideAPI="true" ClientInstanceName="models"
													...
													TabIndex="108" EnableIncrementalFiltering="True" 
											...
											<td>
												<dxe:ASPxButton ID="btnModelAdd" runat="server" AutoPostBack="false" 
													TabIndex="109" ClientInstanceName="modelAdd">
													<BackgroundImage ImageUrl="~/images/add.gif" Repeat="NoRepeat" HorizontalPosition="center" VerticalPosition="center" />
...
<dxpc:ASPxPopupControl ID="ASPxPopupControl1" runat="server" ClientInstanceName="manuForm"
	 ...
	 <ClientSideEvents Shown="function(s, e) { manuName.Focus(); }" />
	 <ContentCollection>
		<dxpc:PopupControlContentControl>
			<table cellpadding="0" cellspacing="0" border="0">
				<tr>
...
<dxpc:ASPxPopupControl ID="ASPxPopupControl2" runat="server" ClientInstanceName="modelForm"
	...
	PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter">
	<ClientSideEvents Shown="function(s, e) { modelName.Focus(); }" />
	<ContentCollection>
		<dxpc:PopupControlContentControl>
			<table cellpadding="0" cellspacing="0" border="0">
				<tr>
...
<%--<dxe:ASPxSpinEdit ID="seInletSize" runat="server" Number="0" Visible="false"
	DecimalPlaces="0" AllowUserInput="true" Width="75" TabIndex="113" 
	MaxValue="10000" ToolTip="Whole Numbers only" NumberType="Integer">
</dxe:ASPxSpinEdit>
<dxe:ASPxSpinEdit ID="seOutletSize" runat="server" Number="0" Visble="false"
