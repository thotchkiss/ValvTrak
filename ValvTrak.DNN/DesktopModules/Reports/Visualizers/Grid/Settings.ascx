<%@ Control Language="VB" AutoEventWireup="false" Inherits="DotNetNuke.Modules.Reports.Visualizers.Grid.Settings" Codebehind="Settings.ascx.vb" %>
...
<table id="tblDataSource" runat="server" cellspacing="0" cellpadding="2" border="0"
    ...
    <tr>
        ...
        <td class="dnn_rpt_form_field">
            <asp:TextBox ID="txtAdditionalCSS" runat="server" Width="100%" />
        </td>
    </tr>
    </tr>
        <tr>
        ...
        <td class="dnn_rpt_form_field">
            <asp:TextBox ID="txtCSSClass" runat="server" Width="100%" />
        </td>
    </tr>
</table>