<%@ control language="C#" autoeventwireup="true" inherits="MediaANT.Modules.DDDCarousel.DDDCarouselModuleImport, App_Web_dddcarouselmoduleimport.ascx.eb29e08c" %>
...
<div id="pagecontainer">
  ...
  <table border="0" class="contenttable Normal" cellpadding="2" cellspacing="2">
    ...
    <tr>
      ...
      <td><asp:FileUpload id="uploadImportFile" runat="server" CssClass="Normal" Width="290px" /></td>
    </tr>
    <tr>
      <td colspan="2">&nbsp;</td>
    </tr>
