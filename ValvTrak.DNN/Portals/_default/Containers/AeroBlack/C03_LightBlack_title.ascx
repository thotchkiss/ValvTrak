...
<div class="container">
    ...
    <div class="C03_roundcont">
        <div class="C03_content">       
           <div runat="server" id="ContentPane" class="C03_ContentPaneB"/>
    ...
    <div class="C03_Black_roundbottom_leftL">
       <img src="<%=skinpath%>dummy.gif" alt="" class="C03_corner_leftB" style="display: none" />
    </div>
    <div class="C03_Black_roundbottom_rightL">
