...
<div class="container">
    <div class="C02_Black_roundtop_leftD">
       <img src="<%=skinpath%>dummy.gif" alt="" class="C02_corner_left" style="display: none" />
    </div>
    <div class="C02_Black_roundtop_rightD">
       <img src="<%=skinpath%>dummy.gif" alt="" class="C02_corner_right" style="display: none" />
    </div>
    <div class="C02_DarkBlack_roundcont">
       <div class="C02_DarkBlack_TitleLine">
           <div class="C02_Black_DarkTitle">
    ...
    <div class="C02_Black_roundbottom_leftD">
       <img src="<%=skinpath%>dummy.gif" alt="" class="C02_corner_left" style="display: none" />
    </div>
    <div class="C02_Black_roundbottom_rightD">
       <img src="<%=skinpath%>dummy.gif" alt="" class="C02_corner_right" style="display: none" />
    </div>
</div>
