...
<table class="flex-container-4 fullwidth">
<tr>
<td class="flex-container-tl trans-png"><img src="<%= SkinPath %>images/spacer.gif" height="24" width="24" alt=""></td><td class="flex-container-t trans-png"></td><td class="flex-container-tr trans-png"><img src="<%= SkinPath %>images/spacer.gif" height="24" width="24" alt=""></td>
</tr>
<tr>
  <td valign="top" class="flex-container-l trans-png"></td>
  <td valign="top" class="flex-container-m trans-png">
        ...
        <tr><td class="flex-container-m-td flex-container-content" align="center" id="ContentPane" runat="server"></td></tr>
...
<tr><td class="flex-container-bl trans-png"><img src="<%= SkinPath %>images/spacer.gif" height="24" width="24" alt=""></td><td class="flex-container-b trans-png"></td><td class="flex-container-br trans-png"><img src="<%= SkinPath %>images/spacer.gif" height="24" width="24" alt=""></td></tr>
</table>
