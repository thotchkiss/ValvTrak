...
<td class="flex-container-tl trans-png"><img src="<%= SkinPath %>images/spacer.gif" height="30" width="14" alt="" /></td>
...
<td class="flex-container-tr trans-png"><img src="<%= SkinPath %>images/spacer.gif" height="30" width="14" alt="" /></td>
</tr>
<tr>
