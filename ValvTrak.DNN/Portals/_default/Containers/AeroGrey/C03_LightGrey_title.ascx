...
<div class="container">
    ...
    <div class="C03_Grey_roundbottom_leftL">
       <img src="<%=skinpath%>dummy.gif" alt="" class="C03_corner_leftB" style="display: none" />
    </div>
    <div class="C03_Grey_roundbottom_rightL">
