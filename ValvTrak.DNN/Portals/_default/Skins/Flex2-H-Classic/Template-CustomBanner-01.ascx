...
<%@ Register TagPrefix="dnn" TagName="LoginSkin" Src="~/DesktopModules/DropDownLogin/Login.ascx" %>
...
<td class="EMSkinM">
	...
	<div id="InnerContainer">
        ...
        <tr><td id="BannerPane" class="CustomBannerPane" runat="server"></td></tr>   
        </table>      
        </div>
        </div>
        ...
        <td class="fullwidth">
            ...
            <div id="LoginContainer">
                ...
                <tr>
                    <td class="EMBaseColour5 trans-png">
                        <div>
                            <dnn:LoginSkin runat="server" ID="dnnLoginSkin" CssClass="user" />
                        </div>
                    </td>
                </tr>
                </table> 
