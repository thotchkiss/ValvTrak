...
<td class="EMSkinM">
	...
	<div id="InnerContainer">
        ...
        <tr><td id="MenuBar"><dnn:NAV runat="server" id="dnnNAV" ProviderName="DNNMenuNavigationProvider" IndicateChildren="true" IndicateChildImageRoot="[SKINPATH]images/spacer.gif" IndicateChildImageSub="[SKINPATH]images/menu-arrow.png" SeparatorHTML="&lt;span class=&quot;tab-sep&quot;&gt;&lt;img src=&quot;images/em-menu-bg.png&quot; class=&quot;trans-png&quot;&gt;&lt;/span&gt;" CSSNodeRoot="mainmenu-idle EMMainMenuItemOff EMBaseColour1 EMMainMenuFont" CSSNodeSelectedRoot="mainmenu-selected EMBaseColour2 EMMainMenuItemOn EMMainMenuFont" CSSNodeHoverRoot="mainmenu-selected EMBaseColour2 EMMainMenuItemOn EMMainMenuFont" CSSBreadCrumbRoot="mainmenu-breadcrumbactive EMBaseColour2 EMMainMenuItemOn EMMainMenuFont" CSSNode="mainmenu-menuitem EMSubMenuItemOff EMMainMenuFont" CSSContainerSub="mainmenu-submenu EMSubMenuItemBGOff EMMainMenuFont EMSubMenuOpacity" CSSNodeHoverSub="submenu-menuitemsel EMSubMenuItemBGOn EMSubMenuItemOn EMMainMenuFont" NodeLeftHTMLRoot="&lt;span class=&quot;tab-left&quot;&gt;&lt;img src=&quot;images/em-menu-l.png&quot; class=&quot;trans-png&quot;&gt;&lt;/span&gt;" NodeRightHTMLRoot="&lt;span class=&quot;tab-right&quot;&gt;&lt;img src=&quot;images/em-menu-r.png&quot; class=&quot;trans-png&quot;&gt;&lt;/span&gt;" /></td></tr>
        </table>
     	</div>
        ...
        <div id="BannerOuterContainer" class="EMBannerImageBG EMBannerHeight">
        <div id="BannerContainer" class="EMBannerImage EMBannerHeight">
        <table cellpadding="0" cellspacing="0" class="EMBannerPanePosition EMBannerPaneWidth">
        <tr><td id="BannerPane" class="BannerPane" runat="server"></td></tr>   
        </table>      
        </div>
        </div>
        ...
        <tr><td id="ContentContainerCell">
            ...
            <tr>
            <td valign="top" class="ContentPane2" id="ContentPane2" runat="server"></td>
            ...
            <tr>
            <td valign="top" class="LeftPane3" id="LeftPane3" runat="server"></td>
...
<td id="FooterCell" class="EMSkinB3">
	<div id="CopyrightContainer" class="EMCopyrightContainer" style="float:left;"><dnn:COPYRIGHT runat="server" id="dnnCOPYRIGHT" CssClass="FooterToken EMFooterFont" /></div>
    <div id="TermsContainer" class="EMTermsContainer" style="float:right;"><dnn:TERMS runat="server" id="dnnTERMS" CssClass="FooterToken EMFooterFont" /></div>
    <div id="PrivacyContainer" class="EMPrivacyContainer" style="float:right;"><dnn:PRIVACY runat="server" id="dnnPRIVACY" CssClass="FooterToken EMFooterFont" /></div> 
</td>
