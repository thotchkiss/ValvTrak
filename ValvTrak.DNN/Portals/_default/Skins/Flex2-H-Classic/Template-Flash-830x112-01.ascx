...
var params = { wmode: "transparent", FlashVars: "XMLpath=<%= SkinPath %>Template-Flash-830x112-01.images.xml" };
swfobject.embedSWF("<%= SkinPath %>flash/flex-830x112.swf", "FlashBannerContainer", "830", "112", "9.0.0", false, false, params);
</script>
