...
<link href="<%=skinpath%>BoxedColor.css" rel="stylesheet" type="text/css" />

<div id="PageBgImage">

<div id="OuterContainer" class="w1024x768">
	<div id="OuterContainerTop">
		<img src="<%=skinpath%>images/boxed.TL.gif" alt="top left corner" width="10" height="10" class="corner" style="display: none;">
	</div>
							...
							<div id="HeaderBanner">
								<div id="HeaderBannerBox">
									<div id="HeaderBannerBoxIn">
										<div class="left"><img src="<%=skinpath%>images/header.bgL.png" alt="headerL" border="0"></div>
										<div class="right"><img src="<%=skinpath%>images/header.bgR.png" alt="headerR" border="0"></div>
									</div>
									<div class="clear"></div>
								</div>
								<div id="HeaderBannerContent">
									<table cellpadding="0" cellspacing="0" border="0" width="100%">
										<tr>
											<td id="HeaderBannerPic" runat="server" class="HeaderBannerPic" visible="false"></td>
											<td id="HeaderBannerText" runat="server" class="HeaderBannerText" visible="false"></td>
										</tr>
									</table>
								</div>
							</div>
	...
	<div id="OuterContainerBottom">
		<img src="<%=skinpath%>images/boxed.BL.gif" alt="bottom left corner" width="10" height="10" class="corner" style="display: none;">
	</div>
</div>
